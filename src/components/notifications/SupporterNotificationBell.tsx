    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            <button
                ...
                `}
                aria-label="SUPPORTER INTELLIGENCE"
            >
                    ...
                    <div className="p-6 border-b border-white/5 bg-white/[0.02]">
                        <div className="flex items-center justify-between mb-1.5">
                            <div className="flex items-center gap-2.5">
                                ...
                                <h3 className="text-lg font-black text-brand-white italic uppercase tracking-tighter">SUPPORTER INTEL</h3>
                            </div>
                            {unreadCount > 0 && (
                                <button
                        ...
                        <p className="text-[8px] font-bold text-neutral-400 uppercase tracking-widest opacity-70">
                            {unreadCount} NEW UPDATES FROM YOUR LINEUP
                        </p>
                    </div>
                    ...
                    <div className="max-h-[420px] overflow-y-auto scrollbar-hide py-3">
                        {loading ? (
                            ...
                            <div className="text-center py-20 px-8">
                                ...
                                <p className="text-[9px] font-black text-brand-white uppercase tracking-[0.3em]">TIMELINE CLEAR</p>
                                <p className="text-[8px] font-bold text-neutral-500 uppercase tracking-widest mt-2">NO PENDING UPDATES FROM YOUR SUPPORTED PROJECTS</p>
                            </div>
                        ) : (
