...
const THANK_YOU_TEMPLATES = [
    {
        ...
        activeColor: 'bg-blue-500/100 text-white border-blue-500',
    ...
    },
    {
        ...
        icon: Rocket,
        label: '🚀 Excited',
        color: 'bg-brand-orange/20 text-brand-orange border-brand-orange/30',
        activeColor: 'bg-brand-orange/100 text-white border-orange-500',
    ...
    },
    {
        ...
        activeColor: 'bg-yellow-500/100 text-white border-yellow-500',
    ...
    return (
        <>
            ...
            >
                {/* Modal */}
                <div
                    className="bg-[#111] rounded-2xl shadow-xl max-w-lg w-full max-h-[90vh] overflow-y-auto"
                ...
                >
                    ...
                    {/* Supporter Info */}
                    <div className="px-6 py-4 bg-gradient-to-r from-brand-orange/10 to-amber-50 border-b border-brand-orange/20">
                        <div className="flex items-center gap-4">
                            {supporter.displayProfileImage ? (
                                ...
                                <div className="w-12 h-12 bg-neutral-800 rounded-full flex items-center justify-center border-2 border-white shadow-sm">
                            ...
                            <div>
                                ...
                                <div className="text-sm text-neutral-400">
                                    Contributed <span className="font-bold text-green-400">{formatCurrency(supporter.totalAmount)}</span>
                            ...
                            {THANK_YOU_TEMPLATES.map(template => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`flex items-center gap-2 px-3 py-2.5 rounded-2xl border text-sm font-medium transition-all ${isSelected
                    ...
                    <div className="p-6">
                        ...
                        <textarea
                            ...
                            rows={5}
                            className={`w-full px-4 py-3 border rounded-3xl resize-none focus:ring-2 focus:ring-brand-acid focus:border-brand-acid transition-colors ${isOverLimit ? 'border-red-300 bg-red-500/10' : 'border-neutral-800'
                                }`}
                        />
                        <div className="flex justify-between items-center mt-2">
                            ...
                            <span className={`text-xs font-medium ${isOverLimit ? 'text-red-500' : characterCount > MAX_MESSAGE_LENGTH * 0.8 ? 'text-orange-500' : 'text-neutral-600'
                                }`}>
                    ...
                    {/* Actions */}
                    <div className="flex items-center justify-end gap-3 p-6 bg-brand-black rounded-b-2xl">
                        <button
                            onClick={handleClose}
                            disabled={isSending}
                            className="px-5 py-2.5 text-neutral-300 font-medium hover:bg-neutral-800 rounded-2xl transition-colors disabled:opacity-50"
                        >
                            Cancel
                        </button>
                        <button
                            ...
                            className="flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-pink-500 to-rose-500 text-white font-medium rounded-2xl hover:from-pink-600 hover:to-rose-600 transition-all shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {isSending ? (
                                <>
